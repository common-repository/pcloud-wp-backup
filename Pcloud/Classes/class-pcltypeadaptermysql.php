...
class PclTypeAdapterMysql {
	 ...
	 * DB Handler.
	 *
	 * @var mixed $db_handler Database handler.
	 */
	protected mixed $db_handler = null;
	 ...
	 */
	protected array $dump_settings = array();
	 ...
	 */
	public array $mysql_types = array(
		'numerical' => array(
			'bit',
			'tinyint',
			'smallint',
	...
	public function parse_column_type( array $col_type ): array {
		...
		$col_info['is_virtual'] = str_contains( $col_type['Extra'], 'VIRTUAL GENERATED' ) || str_contains( $col_type['Extra'], 'STORED GENERATED' );
