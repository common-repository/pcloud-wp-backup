...
class PclMysqlDump {
	 ...
	 */
	public string $file_name = 'php://stdout';
	 ...
	 */
	private ?PclTypeAdapterMysql $type_adapter;
	 ...
	 */
	private array $table_column_types = array();
	 ...
	 */
	private array $table_wheres = array();
	 ...
	 */
	private array $table_limits = array();
	 ...
	 */
	public function get_table_where( string $table_name ): mixed {
	 ...
	 */
	public function get_table_limit( string $table_name ): float|bool|int|string {
	 ...
	 */
	private function parse_dsn( string $dsn ): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function start( string $file_name = '' ): void {
	 ...
	 */
	private function get_database_structure_tables(): void {
	 ...
	 * @throws Exception Standart Exception can be thrown.
	 */
	private function get_database_structure_views(): void {
	 ...
	 * @return void
	 */
	private function get_database_structure_procedures(): void {
	 ...
	 * @return void
	 */
	private function get_database_structure_functions(): void {
		if ( $this->dump_settings['routines'] ) {
	 ...
	 * @throws Exception Standart Exception can be thrown.
	 */
	private function get_database_structure_events(): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function export_tables(): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function export_views(): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function export_procedures(): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function export_functions(): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function export_events(): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_table_structure( string $table_name ): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_view_structure_table( string $view_name ): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_view_structure_view( string $view_name ): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_trigger_structure( string $trigger_name ): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_procedure_structure( string $procedure_name ): void {
		if ( ! $this->dump_settings['skip-comments'] ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_function_structure( string $function_name ): void {
		if ( ! $this->dump_settings['skip-comments'] ) {
			$ret = '--' . PHP_EOL . "-- Dumping routines for database '" . $this->db_name . "'" . PHP_EOL . '--' . PHP_EOL . PHP_EOL;
			$this->compress_write( $ret );
		}
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_event_structure( string $event_name ): void {
		if ( ! $this->dump_settings['skip-comments'] ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function list_values( string $table_name ): void {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function prepare_list_values( string $table_name ): void {
		if ( ! $this->dump_settings['skip-comments'] ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function end_list_values( string $table_name, int $count = 0 ): void {
		if ( $this->dump_settings['disable-keys'] ) {
			$this->compress_write(
