...
class ZipEntry {
	 ...
	 * @var int $created_os
	 */
	private int $created_os = self::UNKNOWN;
	 ...
	 */
	private int $extracted_os = self::UNKNOWN;
	 ...
	 */
	private int $software_version = self::UNKNOWN;
	 ...
	 */
	private int $extract_version = self::UNKNOWN;
	 ...
	 */
	private int $compression_method = self::UNKNOWN;
	 ...
	 */
	private int $general_purpose_bit_flags = 0;
	 ...
	 * @var int $dos_time
	 */
	private int $dos_time = self::UNKNOWN;
	 ...
	 */
	private int $compressed_size = self::UNKNOWN;
	 ...
	 */
	private int $uncompressed_size = self::UNKNOWN;
	 ...
	 */
	private int $internal_attributes = 0;
	 ...
	 */
	private int $external_attributes = 0;
	 ...
	 */
	private int $local_header_offset = 0;
	 ...
	 */
	protected ExtraFieldsCollection $cd_extra_fields;
	 ...
	 */
	protected ExtraFieldsCollection $local_extra_fields;
	 ...
	 */
	private int $encryption_method = ZipEncryptionMethod::NONE;
	 ...
	 */
	private int $compression_level = ZipCompressionLevel::NORMAL;
	 ...
	 * @param mixed|null $charset Entry name charset.
	 *
	 * @throws Exception Throws Exception.
	 */
	public function __construct( string $name, mixed $charset = null ) {
	 ...
	 * @throws Exception Throws Exception.
	 */
	private function set_name( string $name, mixed $charset = null ): void {
	 ...
	 * Set charset.
	 *
	 * @param bool|string|null $charset Charset.
	 *
	 * @return ZipEntry
	 * @throws Exception Throws exception.
	 */
	public function set_charset( bool|string $charset = null ): ZipEntry {
	 ...
	 * Set data.
	 *
	 * @param ZipData $data The Zip data.
	 *
	 * @return void
	 */
	public function set_data( ZipData $data ): void {
		$this->data = $data;
	}
	 ...
	 * @return void
	 */
	private function update_compression_level(): void {
	 ...
	 * @return void
	 */
	private function set_general_bit_flag( int $mask, bool $enable ): void {
		if ( $enable ) {
	 ...
	 * @return void
	 */
	public function enable_data_descriptor( bool $enabled = true ): void {
	 ...
	 * @return void
	 */
	public function enable_utf8_name( bool $enabled ): void {
