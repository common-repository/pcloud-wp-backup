...
final class Zip64ExtraField implements ZipExtraField {
	 ...
	 */
	private ?int $local_header_offset;
	 ...
	 * @return void
	 */
	public function set_uncompressed_size( ?int $uncompressed_size ): void {
		$this->uncompressed_size = $uncompressed_size;
	}
	 ...
	 * @return void
	 */
	public function set_compressed_size( ?int $compressed_size ): void {
		$this->compressed_size = $compressed_size;
	}
	 ...
	 * @return void
	 */
	public function set_local_header_offset( ?int $local_header_offset ): void {
		$this->local_header_offset = $local_header_offset;
	}
