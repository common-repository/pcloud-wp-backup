...
final class WinZipAesExtraField implements ZipExtraField {
	 ...
	 */
	private int $vendor_version = self::VERSION_AE1;
	 ...
	 */
	private int $key_strength = self::KEY_STRENGTH_256BIT;
	 ...
	 * @throws Exception Throws exception.
	 */
	public function set_vendor_version( int $vendor_version ): void {
	 ...
	 * @throws Exception Throws exception.
	 */
	public function set_key_strength( int $key_strength ): void {
	 ...
	 * @throws Exception Throws exception.
	 */
	public function set_compression_method( int $compression_method ): void {
