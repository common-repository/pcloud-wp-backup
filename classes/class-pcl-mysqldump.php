...
class Pcl_Mysqldump {
	 ...
	 * MySQL type adapter.
	 *
	 * @var Pcl_Type_Adapter_Mysql|null $type_adapter
	 */
	 ...
	 */
	public function __construct( $dsn = '', $user = '', $pass = '', $dump_settings = array(), $pdo_settings = array() ) {
	...
	private function connect() {
		...
		$this->type_adapter = Pcl_Type_Adapter_Mysql::create( $this->db_handler, $this->dump_settings );
	}
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function start( $file_name = '' ) {
	 ...
	 * @return string
	 */
	private function get_dump_file_header() {
	 ...
	 */
	private function gettable_column_types( $table_name ) {
		$column_types = array();
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_trigger_structure( $trigger_name ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_procedure_structure( $procedure_name ) {
		if ( ! $this->dump_settings['skip-comments'] ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_function_structure( $function_name ) {
		if ( ! $this->dump_settings['skip-comments'] ) {
			$ret = '--' . PHP_EOL . "-- Dumping routines for database '" . $this->db_name . "'" . PHP_EOL . '--' . PHP_EOL . PHP_EOL;
			$this->compress_write( $ret );
		}
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	private function get_event_structure( $event_name ) {
		if ( ! $this->dump_settings['skip-comments'] ) {
	 ...
	 * @return string
	 */
	private function escape( $col_value, array $col_type ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function compress_open( $file_name ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function compress_write( $str ) {
	 ...
	 * @return bool
	 */
	public function compress_close() {
		if ( ! is_null( $this->file_handler ) ) {
