...
class WP2pCloudFuncs {
	 ...
	 * @return string
	 */
	public static function get_api_ep_hostname() {
	 ...
	 * @return int
	 */
	public static function get_storred_val( $key, $default = '' ) {
	 ...
	 *
	 * @param string           $key Storred item key, must be a string.
	 * @param string|int|float $value Storred item value.
	 */
	public static function set_storred_val( $key, $value ) {
	 ...
	 * Set operation
	 *
	 * @param array $operation_data Array with current operational data, can be empty.
	 *
	 * @return void
	 */
	public static function set_operation( $operation_data = array() ) {
	 ...
	 * @return void
	 */
	public static function add_item_for_async_update( $key, $value ) {
