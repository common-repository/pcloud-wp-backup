<?php
/**
 * Pcl_Type_Adapter_Mysql class
 *
 * @file class-typeadapterfactory.php
 ...
 */
class Pcl_Type_Adapter_Mysql {

	/**
	 * DB Handler
	 *
	 * @var mixed|null $db_handler
	 */
	 ...
	 * Class constructor
	 *
	 * @param PDO   $db_handler DB Handler.
	 * @param array $dump_settings Dump settings.
	 */
	public function __construct( $db_handler = null, $dump_settings = array() ) {
	 ...
	 */
	public static function create( $db_handler = null, $dump_settings = array() ) {
		return new Pcl_Type_Adapter_Mysql( $db_handler, $dump_settings );
	}
	 ...
	 * @return string
	 */
	public function show_create_trigger( $trigger_name ) {
	 ...
	 * @noinspection PhpUnused
	 */
	public function show_create_procedure( $procedure_name ) {
	 ...
	 * @noinspection PhpUnused
	 */
	public function show_create_function( $function_name ) {
	 ...
	 * @noinspection PhpUnused
	 */
	public function show_create_event( $event_name ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function create_view( array $row ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function create_trigger( array $row ) {
	 ...
	 * @noinspection PhpUnused
	 */
	public function create_event( array $row ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function show_views( $tbl_name ) {
		$result  = 'SELECT TABLE_NAME AS tbl_name ';
		$result .= 'FROM INFORMATION_SCHEMA.TABLES ';
	 ...
	 * @return string
	 */
	public function show_triggers( $db_name ) {
	 ...
	 * @return string
	 */
	public function show_procedures( $db_name ) {
	 ...
	 * @return string
	 */
	public function show_functions( $db_name ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function show_events( $db_name ) {
	 ...
	 * @return string
	 */
	public function start_add_lock_table( $table_name ) {
	 ...
	 * @return string
	 */
	public function start_add_disable_keys( $table_name ) {
	 ...
	 * @throws Exception Standart Exception returned.
	 */
	public function end_add_disable_keys( $table_name ) {
	 ...
	 * @return string
	 */
	public function add_drop_database( $db_name ) {
	 ...
	 * @return string
	 */
	public function add_drop_trigger( $trigger_name ) {
	 ...
	 * @noinspection PhpUnused
	 */
	public function get_database_header( $db_name ) {
